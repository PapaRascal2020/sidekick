...
<html>
<head>
    <title>Sidekick Moderation Example</title>
</head>
...
<h1>Moderation Example</h1>
<form method="POST" action="/sidekick/playground/moderate">
    @csrf
    <textarea style="width: 300px; height: 100px;" placeholder="Type a comment to moderate..." name="text" required></textarea>
    <br>
    <input style="width: 300px; height: 50px;" type="submit" value="Moderate this text" />
</form>
